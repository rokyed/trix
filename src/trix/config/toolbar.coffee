  ...
  content: makeFragment """
    <div class="button_groups">
      <span class="button_group text_tools">
        ...
        <button type="button" class="superscript" data-attribute="superscript" title="#{lang.superscript}">#{lang.superscript}</button>
        <button type="button" class="subscript" data-attribute="subscript" title="#{lang.subscript}">#{lang.subscript}</button>
